...
send.addEventListener("click",function(e){
    ...
    axios.get(`https://tdx.transportdata.tw/api/basic/v2/Tourism/ScenicSpot/${city}?%24filter=contains(Class1,'${category}')&%24top=30&%24format=JSON`,{
...
function getApiResponse() {
  const url = `https://tdx.transportdata.tw/api/basic/v2/Tourism/ScenicSpot?%24top=30&%24format=JSON`;
  axios
    .get(url,{
      headers: getAuthorizationHeader()
    })
